...
from mapillary_image_classification.data.osm import add_mapillary_key_to_network, define_categories
from mapillary_image_classification.data.mapillary import (download_mapillary_image_by_key,
